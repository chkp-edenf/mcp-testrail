...
server.addTool({
	...
	execute: async ({ projectId, suiteId, caseIds }) => {
		try {
			...
			const errorMessage =
				error instanceof Error ? error.message : String(error);
			throw new Error(`Error deleting test cases: ${errorMessage}`);
		}
	},
});
...
// Tool to get a specific section
server.addTool({
	name: "getSection",
	...
	execute: async ({ sectionId }) => {
		try {
			...
			const errorMessage =
				error instanceof Error ? error.message : String(error);
			throw new Error(`Error getting section ${sectionId}: ${errorMessage}`);
		}
	},
});

// Tool to get all sections for a project
server.addTool({
	name: "getSections",
	...
	execute: async ({ projectId, suiteId }) => {
		try {
			...
			const errorMessage =
				error instanceof Error ? error.message : String(error);
			throw new Error(
				`Error getting sections for project ${projectId}: ${errorMessage}`,
			);
		}
	},
});

// Tool to add a new section
server.addTool({
	name: "addSection",
	...
	execute: async ({ projectId, name, description, suiteId, parentId }) => {
		try {
			...
			const errorMessage =
				error instanceof Error ? error.message : String(error);
			throw new Error(
				`Error adding section to project ${projectId}: ${errorMessage}`,
			);
		}
	},
});

// Tool to move a section
server.addTool({
	name: "moveSection",
	...
	execute: async ({ sectionId, parentId, afterId }) => {
		try {
			...
			const errorMessage =
				error instanceof Error ? error.message : String(error);
			throw new Error(`Error moving section ${sectionId}: ${errorMessage}`);
		}
	},
});
...
server.addTool({
	...
	execute: async ({ sectionId, name, description }) => {
		try {
			...
			const errorMessage =
				error instanceof Error ? error.message : String(error);
			throw new Error(`Error updating section ${sectionId}: ${errorMessage}`);
		}
	},
});
...
server.addTool({
	...
	execute: async ({ sectionId, soft }) => {
		try {
			...
			const errorMessage =
				error instanceof Error ? error.message : String(error);
			throw new Error(`Error deleting section ${sectionId}: ${errorMessage}`);
		}
	},
});
